/**
 * App.jsx — Video Downloader + Audio Converter
 * Includes: StatusTicker, preview cards, video download,
 * server-side AudioConverter, SEO footer.
 */
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      ...
      {/* ── Main content ── */}
      <main className="flex flex-col items-center px-4 py-8 gap-6 flex-1">
          ...
          {platform && (previewing || preview !== null) && (
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden flex gap-3 p-3 items-center">
              {previewing && !preview?.thumbnail ? (
                ...
                <img src={preview.thumbnail} alt="Video preview"
        ...
        {/* SEO footer */}
        <footer className="mt-8 text-center text-zinc-700 text-xs max-w-xl space-y-1" aria-label="Site keywords">
